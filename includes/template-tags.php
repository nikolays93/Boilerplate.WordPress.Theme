...
if ( ! function_exists( '_boilerplate_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function _boilerplate_posted_on() {
...
if ( ! function_exists( '_boilerplate_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function _boilerplate_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( '_boilerplate_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function _boilerplate_entry_footer() {
...
if ( ! function_exists( '_boilerplate_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function _boilerplate_post_thumbnail() {
